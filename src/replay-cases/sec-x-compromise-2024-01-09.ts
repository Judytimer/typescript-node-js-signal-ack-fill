 ...
 */
export const secXCompromiseCase: HistoricalReplayCase = {
  ...
  baseline: {
    decision: "LONG",
    reason: "Retrospective candidate label: apparent spot-Bitcoin ETF approval was a bullish catalyst. The repository has no retained pre-T0 tick stream with which to reproduce MovingAverageSignal."
  },
  shadow: {
    verdict: "ABSTAIN",
    confidence: 0.78,
...
export const secXCompromiseAssessment = {
  evaluationEligibility: "QUALITATIVE_ONLY" as const,
  ...
  limitations: [
    ...
    "The Baseline LONG label is not reproducible from retained MovingAverageSignal ticks."
  ] as const,
  outcomeSources: [
